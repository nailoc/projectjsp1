		...
		<form id="form1" name="fomr1" method="get" action="product_insert.jsp">
            ...
            <tr>
                ...
                <td><select id="kind" name="kind">
                	...
                	<option value="2">티셔츠</option>
                	<option value="3">아우터</option>
                	<option value="4">데님팬츠</option>
                	<option value="5">코튼팬츠</option>
                	<option value="6">숏팬츠/슬랙스</option>
                	<option value="7">기타팬츠</option>
...
<script>
	...
	function add_row(){
		...
		price1.innerHTML = "<input id='price' name='price'>"
